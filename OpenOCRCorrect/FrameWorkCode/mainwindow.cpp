...
{
    int var ;
    var = ui->textEdit->fontWeight();
    if(var==QFont::Normal)
    {
        ui->textEdit->setFontWeight(QFont::Bold);  //bold
    }
    else if(var == QFont::Bold)
    {
        ui->textEdit->setFontWeight(QFont::Normal);  //unbold
    }
}
...
void MainWindow::on_actionSuperScript_triggered()
{
    ...
    ui->textEdit->insertHtml(QString("<sup>%1</sup>").arg(text));
}
...
void MainWindow::on_actionSubScript_triggered()
{
    QString text = ui->textEdit->textCursor().selectedText();
    ui->textEdit->textCursor().removeSelectedText();
    ui->textEdit->insertHtml(QString("<sub>%1</sub>").arg(text));
}
